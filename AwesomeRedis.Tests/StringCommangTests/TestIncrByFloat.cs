...
namespace AwesomeRedis.Tests.StringTest
{
    public class TestIncrByFloat
    {
        ...
        public void Should_return_string()
        {
            ...
            _redisCommand.IncrByFloat("samplekey", 4.5f).ShouldBeType<string>();
        }
        ...
        public void Return_string_should_be_an_error_string()
        {
            ...
            _redisCommand.IncrByFloat("samplekey", 3.14f).Substring(0, 3).ShouldEqual("ERR");
        }
    }
}